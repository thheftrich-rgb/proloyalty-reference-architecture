...
- Added conceptual system context, business domains and loyalty lifecycle.
- Added machine-readable confirmed capability scope and claim boundaries.
- Added CC BY 4.0 license, citation metadata and Zenodo metadata.

No production endpoints, credentials, customer architectures, customer logos or confidential implementation details are included.
